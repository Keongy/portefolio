        ...
        <div className='education'>
            <div className="section">
                <div className="row align-items-center justify-content-center">
                    <div className="col-5 col-lg-5 order-2 order-lg-1 mt-5 mt-lg-0">
                    ...
                    <div className="col-12 col-lg-6 text-center order-1 order-lg-2 mt-0">
                        <h1 className={`subtitle theme-title-${themeColor} m-3 mt-0`}>{selectedLang.education}</h1>
