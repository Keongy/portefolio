        ...
        <div className='education'>
            <div className="row">
                ...
                <div className="col-12 col-lg-6 text-center mt-5 text-light">
                    ...
                    <ul className='inline justify-content-center'>
                        ...
                        <li>
                            <img src="https://img.icons8.com/color/48/000000/adobe-illustrator--v2.png" alt='illustrator' />
                        </li>
                    </ul>
                </div>
            </div>
            <div className="row justify-content-center mt-5">
                <div className="col-12 text-center mb-5">
                    <h1 className='text-light'>Degrees Received</h1>
                </div>
                {language.FR.education.cardDegrees.map((elem, index) => {
                    return <CardDegrees
                        key={index}
                        title={elem.title}
            ...
            <div className="row py-5 text-light justify-content-center">
                <div className="col-12 text-center">
                    <h1>Certifications</h1>
                </div>
                {language.FR.education.cardCertif.map((elem, index) => {
                    return <CardCertif
                        key={index}
