        ...
        <div className='education'>
            <div className="section">
                <div className="row align-items-center justify-content-center">
                    <div className="col-12 col-sm-10 col-md-9 col-lg-5 mt-5 mt-lg-0">
                    ...
                    <div className="col-12 col-lg-6 text-center mt-0">
                        <h1 className={`display-4 theme-title-${themeColor} mt-4 m-lg-3 `}>{selectedLang.education}</h1>
                        <h3 className={`display-5 theme-title-${themeColor} m-3`}>{selectedLang.subtitle}</h3>
                        <ul className='inline logo justify-content-center'>
                            <li>
                                <img src="https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/48/000000/external-udemycom-is-an-online-learning-and-teaching-platform-logo-shadow-tal-revivo.png" alt='photoshop' />
                            </li>
                            <li>
            ...
            <div className="section">
                <div className="row justify-content-center mt-5">
                    <div className="col-12 text-center my-3">
                        <h1 className={`display-6 theme-title-${themeColor}`}>{selectedLang.degreesReceived}</h1>
                    </div>
            ...
            <div className="section">
                <div className="row py-5 text-light justify-content-between">
                    <div className="col-12 text-center my-3">
                        <h1 className={`display-6 theme-title-${themeColor}`}>Certifications</h1>
                    </div>
