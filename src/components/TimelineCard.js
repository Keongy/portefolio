...
const TimelineCard = ({ item, index, themeColor }) => {
    ...
    return (
        <div className={`card theme-bg-light-${themeColor} w-100`}>
            <div className="card-header position-relative" data-bs-toggle="collapse" data-bs-target={`#card${index}`} aria-controls="card" onClick={handleToggleClick}>
            ...
            <div className="collapse" id={`card${index}`}>
